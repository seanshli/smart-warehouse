# MQTT 功能驗證步驟
## MQTT Functionality Verification Steps

完成 EMQX Cloud 和 Vercel 配置後，驗證 MQTT 功能是否正常運作。
<!-- After completing EMQX Cloud and Vercel configuration, verify MQTT functionality is working correctly. -->

## ✅ 已完成步驟 / Completed Steps

- [x] EMQX Cloud 部署完成
- [x] Vercel 環境變數已設定
- [ ] Supabase 資料庫表已創建（需要驗證）
- [ ] Vercel 已重新部署（需要驗證）
- [ ] MQTT 功能測試（需要執行）
...
1. **檢查環境變數**
   ...
   - Smart Warehouse > Settings > Environment Variables
   - 確認以下變數已設定：
     - [ ] `MQTT_BROKER_URL`
     - [ ] `MQTT_USERNAME`
     - [ ] `MQTT_PASSWORD`
...
**狀態 / Status:** ✅ **驗證步驟指南完成 / Verification Steps Guide Complete**
