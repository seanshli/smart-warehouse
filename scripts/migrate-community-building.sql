...
-- This script adds the new tables and relationships
-- Run this after updating Prisma schema and generating migration

-- Note: This is a reference script. Actual migration should be done via Prisma:
...
ADD COLUMN IF NOT EXISTS building_id TEXT REFERENCES buildings(id) ON DELETE SET NULL ON UPDATE NO ACTION;
