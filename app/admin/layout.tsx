...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  if (adminContext?.isSuperAdmin || 
    ...
    navigation.push(
      ...
      // Only show Working Groups for super admin
      ...(adminContext?.isSuperAdmin ? [{ name: 'Working Groups', href: '/admin/working-groups', icon: UserGroupIcon, current: pathname === '/admin/working-groups' }] : []),
